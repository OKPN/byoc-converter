...
const i18nDict = {
  ja: {
    ...
    btnShareQr: "📱 スマホへ共有",
    btnClear: "クリア",
    kvLimitNotice: "Cloudflare KVの仕様上、アップロードは1ファイルにつき<strong style=\"color: #fff;\">最大25MBまで</strong>となります。画像を変換した場合、メタデータの保持に関しては保証できません。",
  ...
  en: {
    ...
    btnClear: "Clear",
    kvLimitNotice: "Due to Cloudflare KV specs, max file size is <strong style=\"color: #fff;\">25MB per file</strong>. Metadata retention is not guaranteed when converted.",
