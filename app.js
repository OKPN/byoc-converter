...
const i18nDict = {
  ja: {
    ...
    btnPinBackup: "🔗 PIN付きバックアップURL",
    pinModalTitle: "🔑 PINコードで接続情報を復元",
    pinModalSub: "発行時に生成された 6桁のパスコード (PINコード) を入力してください。",
    btnDecryptSave: "復号して保存",
    pinDisplayTitle: "🔐 暗号化バックアップURLを発行しました",
    pinDisplaySub: "バックアップURLがクリップボードにコピーされました。<br>復元には以下の 6桁PINコード が必要です。",
    autoGeneratedPinLabel: "【 自動生成された復元用 6桁 PIN 】",
    pinMemoNotice: "※ この6桁のPIN数字をメモ帳等に控えておいてください",
    backupUrlLabel: "暗号化バックアップURL:",
    promptSelect: "-- 定型文を選択 --",
    promptNew: "🆕 新しい定型文を追加...",
    promptSave: "定型文を保存",
    promptDelete: "削除",
  ...
  en: {
    ...
    btnPinBackup: "🔗 Encrypted PIN Backup URL",
    pinModalTitle: "🔑 Restore Credentials via PIN",
    pinModalSub: "Enter the 6-digit PIN code generated when backed up.",
    btnDecryptSave: "Decrypt & Save",
    pinDisplayTitle: "🔐 Encrypted Backup URL Generated",
    pinDisplaySub: "Backup URL copied to clipboard.<br>Restoration requires the 6-digit PIN below.",
    autoGeneratedPinLabel: "[ Auto-Generated 6-Digit PIN ]",
    pinMemoNotice: "* Please keep this 6-digit PIN saved in a safe place.",
    backupUrlLabel: "Encrypted Backup URL:",
